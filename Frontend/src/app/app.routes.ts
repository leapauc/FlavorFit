...
import { HebmealgeneratorPatientComponent } from './pages/espace-patient/hebmealgenerator/hebmealgenerator.component';
import { PlanningPasseComponent } from './pages/espace-patient/planning-passe/planning-passe.component';
import { ContactComponent } from './pages/espace-patient/contact/contact.component';
import { ContainteComponent } from './pages/espace-patient/containte/containte.component';
import { EspacePraticienComponent } from './pages/espace-praticien/espace-praticien.component';
import { EspacePatientComponent } from './pages/espace-patient/espace-patient.component';
